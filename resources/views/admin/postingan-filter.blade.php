...
<div class="mt-4">
	...
	<a href="/admin/postingan/all" type="button" class="btn btn-primary">Reset</a>	
	<br />
	<br />
...
<script type="text/javascript">
	$(function () {
		...
		var table = $('.data-table').DataTable({
			processing: true,
			serverSide: true,
			ajax: "/admin/postingan/filter?komisariat{{app('request')->input('komisariat')}}&rayon={{app('request')->input('rayon')}}",
			columns: [
