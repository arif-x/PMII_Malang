...
<div class="mt-4">
	...
	<a href="/admin-komisariat/kader/all" type="button" class="btn btn-primary">Reset</a>	
	<br />
	<br />
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="GET" action="/admin-komisariat/kader/filter">
						...
						<div class="row">							
							<div class="col-md-6">
								<div class="form-group">
									<label for="komisariatPenyelenggara" class="col-form-label">Rayon</label>
