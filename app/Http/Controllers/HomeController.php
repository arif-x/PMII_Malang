...
class HomeController extends Controller
{
    ...
    public function adminIndex(){
        ...
        return view('admin.dashboard', ['moduls' => $modul, 'videos' => $video, 'cuk' => $responseBody]);
    }

    public function komIndex(){
        $modul = Modul::join('profile', 'profile.id_user', '=', 'postingan.id_user')
        ->where('jenis_post', 1)
        ->select('postingan.*', 'profile.nama_lengkap')
        ->orderBy('id_post', 'DESC')
        ...
        return view('komisariat.dashboard', ['moduls' => $modul, 'videos' => $video, 'cuk' => $responseBody]);
    }
    ...
    public function rayonIndex(){
        ...
        return view('rayon.dashboard', ['moduls' => $modul, 'videos' => $video, 'cuk' => $responseBody]);
    }
}
